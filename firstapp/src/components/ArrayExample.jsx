...
function ArrayExample() {
  const [students, setStudents] = useState(["Nisha", "Anisha", "Manisha"]);
  const quotesData = [
    {
      id: 1,
      quote:
  ...
  const booksData = [
    { id: 101, name: "Java programming", price: 450 },
    { id: 102, name: "Mastering spring boot", price: 500 },
  ];
  ...
  return (
    <div>
      <button onClick={() => setStudents([...students, "Kirti"])}>Click</button>
      <ul>
        {students.map((s, i) => (
          <li key={i}>
            {s} {i}
